...
public class ScarletMarbleDiceBlockEntity extends BlockEntity {
    ...
    public ScarletMarbleDiceBlockEntity(BlockPos pPos, BlockState pBlockState) {
        super(BlockEntityRegistry.SCARLET_MARBLE_DICE_BLOCK_ENTITY.get(), pPos, pBlockState);
    }
