...
public class ScalableHorizontalPlaneBlock extends Block {
    public final float height;

    public ScalableHorizontalPlaneBlock(Properties pProperties, float height) {
        super(pProperties);
        this.height = height;
    }

    public VoxelShape getShape(BlockState p_152917_, BlockGetter p_152918_, BlockPos p_152919_, CollisionContext p_152920_) {
        return Block.box(0.0F, 0.0F, 0.0F, 16.0F, height, 16.0F);
    }
